---
title: Almanack of Kenneth C. Moncur
tagline: A guide to digital freedom, discipline, and legacy.
layout: page.njk
---
<div style="display: flex; flex-direction: column; justify-content: center; align-items: center; min-height: 75vh; text-align: center; color: #333;">
  ...
  <div style="margin-bottom: 3rem;">
    <p style="margin-bottom: 1rem;">Explore:</p>
    <ul style="list-style: none; padding: 0; line-height: 2;">
      <li><a href="/pages/table_of_contents/">Table of Contents</a></li>
      <li><a href="/pages/my_philosophy/">My Philosophy</a></li>
    </ul>
  </div>
  <p><em>Feel the island breeze, discover wisdom, and chart your own course.</em></p>
</div>